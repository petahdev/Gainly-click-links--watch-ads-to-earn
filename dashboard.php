                    ...
                    <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">
                        ...
                        <li class="dropdown topbar-item">
                            <a class="nav-link dropdown-toggle arrow-none nav-icon" data-bs-toggle="dropdown" href="dark-ecommerce-index.html#" role="button"
                                ...
                                <img src="assets/images/users/userimg.jpg" alt="Me" class="thumb-lg rounded-circle">
                            </a>
                            <div class="dropdown-menu dropdown-menu-end py-0">
                                <div class="d-flex align-items-center dropdown-item py-2 bg-secondary-subtle">
                                    <div class="flex-shrink-0">
                                        <img src="assets/images/users/userimg.jpg" alt="Hi" class="thumb-md rounded-circle">
                                    </div>
                                        ...
                                        <div class="card-body"> 
                                            <div class="row d-flex justify-content-center ">
                                                <div class="col-12 col-md-6">
                                                    <h2 class="fs-22 mt-0 mb-1 fw-bold">Kshs <?php echo number_format($total_amount_earned, 2); ?></h2>
                                                    <p class="mb-0 text-truncate text-muted"><span class="text-success"><i class="mdi mdi-trending-up"></i><?php echo $daily_clicks; ?></span> Today's Ad Sessions</p>                                           
